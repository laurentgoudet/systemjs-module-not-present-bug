...
$__System.registerDynamic('f', ['d', 'e', '3'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var define,
      global = this || self,
      GLOBAL = global;
  var customEvent = $__require('d');
  var eventmap = $__require('e');
...
$__System.registerDynamic('12', ['13'], true, function ($__require, exports, module) {
  ...
  var define,
      global = this || self,
      GLOBAL = global;
  var rangeToTextRange = $__require('13');
  var doc = global.document;
  var body = doc.body;
...
$__System.registerDynamic('15', ['10', '11', '12', '14'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var getSelection;
  var doc = global.document;
  var getSelectionRaw = $__require('10');
  var getSelectionNullOp = $__require('11');
  var getSelectionSynthetic = $__require('12');
  var isHost = $__require('14');
...
$__System.registerDynamic('16', ['15', '13'], true, function ($__require, exports, module) {
  'use strict';

  var define,
      global = this || self,
      GLOBAL = global;
  var getSelection = $__require('15');
  var rangeToTextRange = $__require('13');
  var doc = global.document;
...
$__System.registerDynamic('17', ['15', '16'], true, function ($__require, exports, module) {
  'use strict';
...
$__System.registerDynamic('19', ['c', 'f', '17', '18'], true, function ($__require, exports, module) {
  'use strict';

  var define,
      global = this || self,
      GLOBAL = global;
  var sell = $__require('c');
  var crossvent = $__require('f');
  var seleccion = $__require('17');
  var throttle = $__require('18');
...
$__System.registerDynamic('1a', ['f', '18', '19'], true, function ($__require, exports, module) {
  'use strict';
...
$__System.registerDynamic('1c', ['22', '1a', '1b', '1d', '1e', '1f', '20', '21', '3'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var define,
      global = this || self,
      GLOBAL = global;
  var crossvent = $__require('22');
  var bullseye = $__require('1a');
  var throttle = $__require('1b');
  var clone = $__require('1d');
  var defaults = $__require('1e');
  var calendar = $__require('1f');
  var momentum = $__require('20');
  var classes = $__require('21');
...
$__System.registerDynamic('22', ['23', '24', '3'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var define,
      global = this || self,
      GLOBAL = global;
  var customEvent = $__require('23');
  var eventmap = $__require('24');
  var doc = document;
  var addEvent = addEventEasy;
  var removeEvent = removeEventEasy;
  var hardCache = [];
...
$__System.registerDynamic('28', ['25', '27'], true, function ($__require, exports, module) {
  'use strict';

  var define,
      global = this || self,
      GLOBAL = global;
  var atoa = $__require('25');
  var debounce = $__require('27');
...
$__System.registerDynamic('1d', ['20', '3'], true, function ($__require, exports, module) {
  'use strict';
...
$__System.registerDynamic('1e', ['2b', '2c', '20', '3'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var define,
      global = this || self,
      GLOBAL = global;
  var parse = $__require('2b');
  var isInput = $__require('2c');
  var momentum = $__require('20');
...
$__System.registerDynamic('1f', ['22', '28', '29', '2a', '2b', '1d', '1e', '20', '21', '2d', '3'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var dom = $__require('29');
  var text = $__require('2a');
  var parse = $__require('2b');
  var clone = $__require('1d');
  var defaults = $__require('1e');
  var momentum = $__require('20');
  var classes = $__require('21');
  var noop = $__require('2d');
  var no;
...
$__System.registerDynamic('2e', ['1f', '3'], true, function ($__require, exports, module) {
  'use strict';
...
$__System.registerDynamic('2f', ['30', '1c', '2e', '2c', '3'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var define,
      global = this || self,
      GLOBAL = global;
  var index = $__require('30');
  var input = $__require('1c');
  var inline = $__require('2e');
  var isInput = $__require('2c');
...
$__System.registerDynamic('31', ['20', '3'], true, function ($__require, exports, module) {
  'use strict';
...
$__System.registerDynamic('2b', ['20', '3'], true, function ($__require, exports, module) {
  'use strict';
...
$__System.registerDynamic('32', ['2c', '3'], true, function ($__require, exports, module) {
  'use strict';
...
$__System.registerDynamic('33', ['30', '2b', '32', '3'], true, function ($__require, exports, module) {
  'use strict';
...
$__System.registerDynamic('34', ['2', '4', '5', '6', '7', '8', '9', 'a', 'b', '2f', '30', '31', '33', '3'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var index = $__require('30');
  var use = $__require('31');

  core.use = use.bind(core);
  core.find = index.find;
  core.val = $__require('33');
...
$__System.registerDynamic('35', ['36', '34', '3'], true, function ($__require, exports, module) {
  'use strict';
  ...
  var define,
      global = this || self,
      GLOBAL = global;
  var moment = $__require('36');
  var rome = $__require('34');
...
$__System.register('1', ['35'], function (_export, _context) {
  "use strict";
